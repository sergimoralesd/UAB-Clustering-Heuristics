...
if __name__ == "__main__":
    ...
    tx = Tx.from_txid("949591ad468cef5c41656c0a502d9500671ee421fadb590fbc6373000039b693")
    tx.import_previous_txs()
    tx.import_future_txs(future_txids=["e3741b3f560e2cd9dcd984a2c9b6d07e4c3ee077ce3683ea96e6287a40931f7f"])
    tx.print_summary()
    print(list(CScript(bytes.fromhex(tx.inputs_scriptSig[0]))))
