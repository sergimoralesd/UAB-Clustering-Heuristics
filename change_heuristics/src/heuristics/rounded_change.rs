...
mod tests {
    ...
    fn test_present_addr_reuse_heuristic() -> Result<(),AppError> {
        ...
        let _ = run_heuristic_test(&RoundedChange::new(4), txids, expected_results, false)?;

        let txids = vec!["134d82e432ba31b59e6940cace017f969a2d37feffcccce7c3367587b389af41"];
        let expected_results = vec![vec![true, false]];
        let _ = run_heuristic_test(&RoundedChange::new(2), txids, expected_results, false)?;
        ...
        let expected_results = vec![vec![true, true]];
        let _ = run_heuristic_test(&RoundedChange::new(1), txids, expected_results, false)?;
