...
Identifies the change output by exploiting the fact that wallets tend to generate consistent transactions. By checking the "version" field and looking for coincidences with the spending transactions, this heuristic is able to determine the change output.
